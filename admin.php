...
if(isset($_POST['add_item'])){
    ...
    $item_image = "$uploads_dir/$imgName.$fileType";
...
if(isset($_POST['submit_admin'])){
    ...
    $user = $Cart->getUsers($email, $password);
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body>
    ...
    if(!isset($_SESSION['admin'])){?>
        <div class="form w-25 m-auto mt-5">
            <form method="post">
                <div class="mb-3">
    ...
    <?php }else{?>
        <a href="logout.php" class="btn btn-danger m-3 mb-0">Log Out</a>
